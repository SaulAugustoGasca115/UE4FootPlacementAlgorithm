...
#include "FootAlgorithmCharacter.generated.h"

UCLASS(config=Game)
class AFootAlgorithmCharacter : public ACharacter
{
	GENERATED_BODY()
...
//***Foot Placement Algorithm Section
//Rename the Foot Bones 
protected:
...
private:
	...
	//Initial skeletal mesh location
